...
import com.sun.data.remote.response.BaseErrorResponse
...
class BaseException : RuntimeException {
    ...
    val serverErrorCode: Int
        get() = if (errorResponse != null && errorResponse!!.code != null)
    ...
    override val message: String?
        get() = when (errorType) {
            SERVER -> if (errorResponse != null
                ...
                && errorResponse!!.errors!![0].name != null
                && errorResponse!!.errors!![0].name!!.isNotEmpty()
            ) {
                errorResponse!!.errors!![0].name!![0]
            } else null
